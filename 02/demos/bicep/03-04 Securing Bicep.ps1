...
$KVName = (az deployment group create --resource-group $RG --template-file .\bicep-fragments\keyvault.bicep `
...
az deployment group create --resource-group $RG --template-file .\bicep-fragments\sql_kv.bicep `
...
$Servername = $sqlserver + '.database.usgovcloudapi.net'
